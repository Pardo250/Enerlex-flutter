  ...
  Future<void> _iniciarSesion() async {
    ...
    try {
      ...
      if (response.user != null) {
        ...
        AppState().registrar(
          nombre: perfil['nombre'] ?? correo.split('@').first,
          correo: correo,
          password: password,
        );
      ...
      _showSnack('Error al iniciar sesión. Intenta de nuevo.', error: true);
    } finally {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                _buildTextField(controller: _emailController, hintText: 'correo@ejemplo.com', keyboardType: TextInputType.emailAddress),
                const SizedBox(height: 14),
                _buildTextField(
                  controller: _passwordController, hintText: '••••••••', obscureText: _obscurePassword,
                  suffixIcon: GestureDetector(
                    onTap: () => setState(() => _obscurePassword = !_obscurePassword),
                    child: Icon(_obscurePassword ? Icons.visibility_off_outlined : Icons.visibility_outlined, color: _textMuted, size: 22),
                  ),
                ),
                const SizedBox(height: 14),
                Align(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _loading
                        ...
                        : const Text('Iniciar sesión', style: TextStyle(fontSize: 15.5, fontWeight: FontWeight.w600)),
                  ),
                ),
