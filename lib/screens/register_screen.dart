...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _crearCuenta() {
    ...
    // Navegar al home reemplazando toda la pila
            ...
            children: [
              ...
              _buildTextField(
                ...
                suffixIcon: GestureDetector(
                  ...
                  child: Icon(_obscureConfirm ? Icons.visibility_off_outlined : Icons.visibility_outlined, color: _textMuted, size: 22),
                ),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Crear cuenta', style: TextStyle(fontSize: 15.5, fontWeight: FontWeight.w600)),
                ),
              ),
              const SizedBox(height: 28),
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.pop(context),
                    child: const Text('Iniciar sesión', style: TextStyle(color: _accent, fontSize: 13.5, fontWeight: FontWeight.w600)),
                  ),
                ],
              ),
              const SizedBox(height: 32),
